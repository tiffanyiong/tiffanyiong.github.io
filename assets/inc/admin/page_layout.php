...
class WDWT_layout_page_class{
  ...
  function __construct(){
    ...
    $this->options = array(
      ...
      "description" => __( "Default layout. Check to have full width content. Uncheck to have boxed layout.", WDWT_LANG),
      'show' => array(''),
    ...
    'content_area_percent' => array( 
      ...
      "title" => __("Box Width", WDWT_LANG), 
      'type' => 'number',
      "sanitize_type" => "sanitize_text_field",  
      "description" => __("Specify the width of the Content area if boxed layout", WDWT_LANG),
      'unit_symbol' => '%',
      'step' => '1',
      'min' => '75',
      'max' => '99',
      ...
      'default_layout' => array(
        "name" => "default_layout", 
        "title" => __("Choose Default Layout of Content", WDWT_LANG), 
        'type' => 'layout_open', 
