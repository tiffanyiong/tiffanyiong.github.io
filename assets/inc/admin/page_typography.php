...
class WDWT_typography_page_class{
	...
	function __construct(){
		$this->options = array(
			...
			'text_headers_font' => array(
				...
				'title' => __( 'Select Font', WDWT_LANG ),
				'description' => __( 'Fonts with * are not loaded from Google, they will be displayed only if visitor\'s device has them installed.', WDWT_LANG ),
				'type' => 'select_style',
			...
			'text_headers_button' => array(
				...
				'title' => __( 'Edit font styling', WDWT_LANG ),
				'type' => 'button',
				'show' => array(
					'text_headers_kern',
			...
			'text_headers_kern' => array(
				...
				'title' => __( 'Letter Spacing', WDWT_LANG ),
				'type' => 'select_style',
			...
			'text_headers_transform' => array(
				...
				'title' => __( 'Text Transform', WDWT_LANG ),
				'type' => 'select_style',
	...
	public function fonts_options(){
		$font_choices[ 'Open Sans, sans-serif' ] = 'Open Sans (sans-serif)'; //default, keep first
