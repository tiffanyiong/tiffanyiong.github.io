...
class WDWT_admin_view{
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_diagram wdwt_diagram_<?php echo $element['name']; ?> last_percent" id="wdwt_diagram_<?php echo $element['name']; ?>_0">
        ...
        <div class="diagram-from-base_title">
          <div  valign="middle">
            <h4><?php esc_html_e("Title", WDWT_LANG); ?></h4>
          </div>
        ...
        <div class="diagram-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h4><?php esc_html_e("Percent", WDWT_LANG); ?></h4>
          </div>
          <div>
  ...
  public function text_preview($element, $context='option', $opt_val='', $meta=array()){
    ...
    <div class="font_preview_wrap" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <label class="typagrphy_label" for="" style="font-size:18px;font-size: 20px;font-family: sans-serif;"><?php echo __('Preview', WDWT_LANG ); ?></label>
  ...
  public function upload_single($element, $context='', $opt_val=''){
    ...
    $filetype = (isset($element["filetype"]) && $element["filetype"] != '') ? $element["filetype"] : $this->params["upload_filetype"];
    ...
    <script>
      jQuery(document).ready(function ($) {
        ...
        /*reset to default*/
        jQuery('#resetdef_<?php echo $element['name']; ?>').on('click', function () {
          var defaultImgValue = jQuery('#default_<?php echo $element["name"] ?>').val();
          var url_input = jQuery('#<?php echo $element["name"]; ?>');
          url_input.val(defaultImgValue);
          url_input.change();
          return false;
        });
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="optioninput" id="upload_images">
        ...
        <input class="reset-button button" type="button" id="resetdef_<?php echo $element['name']; ?>" value="<?php esc_attr_e('Reset', WDWT_LANG); ?>" />
        <input type="hidden" class="defaultImgValue" id="default_<?php echo $element["name"] ?>" value="<?php echo $element['default']; ?>" />
      </div>
    </div>
    <?php
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_slide wdwt_slide_<?php echo $element['name']; ?> last_slide" id="wdwt_slide_<?php echo $element['name']; ?>_0">
        ...
        <div class="slide-from-base_url" style="margin-bottom:3%;">
          <div valign="middle"><h4><?php esc_html_e("Image URL",WDWT_LANG); ?></h4></div>
          <div>
        ...
        <div class="slide-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h4><?php esc_html_e("Image Description", WDWT_LANG); ?></h4>
          </div>
          <div>
